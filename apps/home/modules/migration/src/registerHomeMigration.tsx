...
async function registerMsw(runtime: FireflyRuntime) {
    if (runtime.isMswEnabled) {
        ...
        const requestHandlers = (await import("./apiMocks/getRequestHandlers.js")).getRequestHandlers(runtime.environmentVariables);
...
function registerRoutes(runtime: FireflyRuntime) {
    runtime.registerRoute({
        path: "/migration",
        lazy: async () => {
            const { MigrationPage } = await import("./MigrationPage.js");
...
export const registerHomeMigration: ModuleRegisterFunction<FireflyRuntime> = async runtime => {
